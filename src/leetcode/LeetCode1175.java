...
public class LeetCode1175 {
    public int numPrimeArrangements(int n) {
        ...
        // 算阶乘
        return (int) ((factorial(num) * factorial(n - num)) % 1000000007);
    }
